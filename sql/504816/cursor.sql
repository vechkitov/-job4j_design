...
MOVE BACKWARD FROM cursor_products;--18
FETCH BACKWARD 2 FROM cursor_products;--17 16
MOVE PRIOR FROM cursor_products;--15
FETCH BACKWARD 4 FROM cursor_products;--14 13 12 11
MOVE BACKWARD 5 FROM cursor_products;--10 9 8 7 6
FETCH BACKWARD 4 FROM cursor_products;--5 4 3 2
FETCH FIRST FROM cursor_products;--1
